        ...
        <div className="p-8 space-y-10">
            <header className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-3xl font-black uppercase tracking-tighter italic text-slate-800 dark:text-white">Diagnostic & Santé Système</h2>
                        <p className="text-slate-500 text-xs font-black uppercase tracking-widest mt-0.5">Surveillance en temps réel de l'intégrité des raccordements</p>
                    </div>
                </div>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className={`p-8 rounded-[2rem] border ${isDarkMode ? 'bg-amber-500/5 border-amber-500/20' : 'bg-amber-50 border-amber-100'}`}>
